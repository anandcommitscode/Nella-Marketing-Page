...
export const metadata: Metadata = {
  title: 'the myth of the ten step routine | stories',
  description: 'why adding more actives usually results in a broken barrier, and how to actually measure what is working.',
  alternates: {
    canonical: 'https://mynella.app/stories/the-myth-of-the-ten-step-routine'
  }
};
  ...
  return (
    <div className="space-y-0">
      ...
      <div className="flex items-center gap-2 text-[13px] font-semibold text-grey">
        ...
        <span className="text-grey font-normal">&gt;</span>
        <span className="text-espresso">The myth of the ten step routine</span>
      </div>
